...
static void display(void) {
    ...
    for (i = 0; i < N-1; ++i)
      {
	glVertex2f(g_x_coords[i], g_sin_values[i]);glVertex2f(g_x_coords[i+1], g_sin_values[i+1]);
    ...
    for (i = 0; i < N-1; ++i)
      {
	glVertex2f(g_x_coords[i], g_cos_values[i]);glVertex2f(g_x_coords[i+1], g_cos_values[i+1]);
    ...
    for (i = 0; i < N-1; ++i)
      {
	glVertex2f(g_x_coords[i], g_x2_values[i]);glVertex2f(g_x_coords[i+1], g_x2_values[i+1]);
